    ...
    <>
      ...
      <div style={{borderRadius: 10, backgroundColor: 'white', height: 800, width: 1200, display: 'flex'}}>
        <div style={{padding: 20}}>
          ...
          <div style={{padding: 20, alignContent: 'center', width: 200}}>
            <h3 style={{color: 'black', fontSize: 20}}>Statistic</h3>
            <Select onChange={(x) => setStat(x['value'])} options={stats} defaultValue={stats[0]} styles={{
              option: (provided) => ({
                ...provided,
                color: 'black'
              })
        ...
        <div style={{padding: 30, paddingTop: 100}}>
          <img src={'Hostnames\\' + hostname + '\\' + hostname + '_' + device + '_' + stat + '.png'}></img>
        </div>
      </div>
    </>
  )
