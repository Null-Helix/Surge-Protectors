...
host_hub_clean_1_day <- host_hub_instances %>%
  filter(year == 2022, day == 27, hour == 2, minute == 1, second %in% c(1:50))

ggplot(host_hub_clean_1_day, aes(x = timestamp, y = B.STATE.V)) +
  geom_point() + 
  labs(x = "Timestamp", y = "Voltage") +
  ggtitle("Voltage vs Timestamp")
