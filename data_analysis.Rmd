...
Package Installation:
  - If this is the first time you are running this Rmd file and you do not have the dplyr, jsonlite, ggplot2, tidyr library installed, uncomment the first four line and run the R chunk.
  - Remember to comment out the first four line again after you have installed dplyr, jsonlite, ggplot2, tidyr into your RStudio environment.
...
Assumptions:
  ...
  - Batteries can not be uniquely identified(Future inference on voltage, current, etc. trends will hopefully show a system that can uniquely identify these batteries)
